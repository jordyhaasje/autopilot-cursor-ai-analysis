...
async function updateEmailFilterNodeRealtime() {
  console.log('🔧 Updating N8N Email Filter Node Realtime...\n');
...
return await filterEmail();`;
    ...
    // Prepare workflow update (remove unnecessary fields)
