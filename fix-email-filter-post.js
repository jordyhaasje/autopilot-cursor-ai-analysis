...
async function fixEmailFilterPost() {
  console.log('🔧 Fixing Email Filter Node with POST...\n');
...
return await filterEmail();`;
    ...
    // Try to update using POST to workflow update endpoint
    console.log('📤 Updating workflow with POST...');
